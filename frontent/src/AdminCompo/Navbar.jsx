    ...
    return (
      ...
      <h1 className="text-sm sm:text-lg font-black text-center flex-1 truncate md:text-3xl tracking-tighter uppercase italic">
        University <span className="text-indigo-400">Security</span> Management
            ...
            {/* RIGHT: Logout */}
            <button className="items-center gap-2 bg-white text-gray-800 font-medium md:px-3 md:py-2 sm:px-2 sm:py-2 rounded-md  max-sm:py-1 max-sm:text-base  md:flex sm:lg hover:bg-black hover:text-white transition-all duration-300 ease-in-out">
